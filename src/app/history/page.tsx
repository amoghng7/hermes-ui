        ...
        <div className="flex-1 overflow-y-auto p-8 flex flex-col gap-8 custom-scrollbar">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <p className="text-[1rem] text-on-surface leading-relaxed">
              ...
              <div className="mt-6 p-4 rounded-2xl bg-terminal-bg border border-border-default font-code text-[0.8125rem]">
      ...
      >
        <div className="p-6 border-b border-border-subtle">
          ...
          <div className="flex gap-2 mt-2">
            ...
            <span className="px-3 py-1 rounded-full bg-surface-container-high text-text-muted text-[0.6875rem] uppercase font-bold tracking-wider">
              Historical Sync
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 relative flex items-center justify-center overflow-hidden">
          ...
          {showCard && (
            <div
              ...
              tabIndex={-1}
              className="absolute inset-x-6 top-24 z-30 bg-surface-container-high text-on-surface rounded-3xl p-6 shadow-2xl border border-border-default focus:outline-none"
            >
              ...
              <div className="space-y-4">
                <section aria-labelledby="role-desc-heading">
                  <h5 id="role-desc-heading" className="text-[0.75rem] font-bold uppercase tracking-wider text-primary mb-2">
                    Role Description
                  </h5>
              ...
              <div className="mt-8 pt-4 border-t border-border-subtle flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-[0.8125rem] font-semibold text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm"
